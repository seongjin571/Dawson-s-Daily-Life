...
// audioArray[0]= new Audio('sound/step1.mp3');
// audioArray[1]= new Audio('sound/step2.mp3');
// audioArray[2]= new Audio('sound/step3.mp3');
// audioArray[0].volume=1;
// audioArray[1].volume=1;
// audioArray[2].volume=1;
audioArray= new Audio('sound/step2.mp3');
var Run=0;
var move=0;
