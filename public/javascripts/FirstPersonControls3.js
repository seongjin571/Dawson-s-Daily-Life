...
var audioArray=new Array();
 ...
 audioArray[0]= new Audio('/sound/step2_2.mp3');
 audioArray[1]= new Audio('/sound/step2_3.mp3');


 audioArray[0].volume=0.5;
 audioArray[1].volume=0.5;
...
THREE.FirstPersonControls = function ( object,domElement ) {
  ...
  this.onKeyDown = function ( event ) {
    ...
    switch( event.keyCode ) {
      ...
      case 77:/*M*/ this.freeze = true; document.getElementById('radar').style.display = "block"; break;

      case 16: /*shift*/this.movementSpeed=300;break;/////////////////////////////////
    }
  ...
  this.onKeyUp = function ( event ) {
    ...
    switch( event.keyCode ) {
      ...
      case 16: /*shift*/ this.movementSpeed=200;break;//////////////////////////////////////////////
    }
    ...
    if ( this.freeze ) {
      ...
      if ( this.moveForward || ( this.autoForward && !this.moveBackward ) ) {
        ...
        if (checkWallCollision(this.object.position)) {
          this.object.translateZ( actualMoveSpeed + this.autoSpeedFactor+20 );
        }
      ...
      if ( this.moveBackward ) {
        ...
        if (checkWallCollision(this.object.position)) {
          this.object.translateZ( - actualMoveSpeed-20 );
        }
      ...
      if ( this.moveLeft ) {
        ...
        if (checkWallCollision(this.object.position)) {
          this.object.translateX( actualMoveSpeed+20 );
        }
